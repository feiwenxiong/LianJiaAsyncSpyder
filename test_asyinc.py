    ...
    async with semaphore:
        ...
        async with aiohttp.ClientSession() as session:
            ...
            for url in urls:
               ...
               "Referer":"https://sh.lianjia.com/yangjing",
...
if __name__ == "__main__":
    ...
    urls = [f"https://sh.lianjia.com/ershoufang/yangjing/pg{i}/"  for i in range(1,6) ]
    print(urls)
    
    asyncio.run(get_pages(urls,max_concurrency=max_concurrency,ban_kuai="yangjing",semaphore=semaphore))